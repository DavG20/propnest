export default {
  ...
  Auth: {
    ...
    ForgotPassword: {
      ...
      subtitle: 'ኢሜልዎን ያስገቡ እና የይለፍ ቃል መለወጫ አገናኝ እንልካለን።',
      email: 'የኢሜል አድራሻ',
      submit: 'የዳግም ማስጀመሪያ አገናኝ ላክ',
      backToLogin: 'ወደ ግባ ይመለሱ',
      successTitle: 'ሳጥንዎን ይፈትሹ',
      successMessage: 'ወደ ኢሜልዎ የይለፍ ቃል መለወጫ አገናኝ ልከናል።',
    },
    ResetPassword: {
      title: 'አዲስ የይለፍ ቃል ያስቀምጡ',
      subtitle: 'አዲሱ የይለፍ ቃልዎ ቢያንስ 8 ቁምፊዎች መሆን አለበት።',
      password: 'አዲስ የይለፍ ቃል',
      confirmPassword: 'አዲሱን የይለፍ ቃል ያረጋግጡ',
      submit: 'የይለፍ ቃል ዳግም አስጀምር',
      backToLogin: 'ወደ ግባ ይመለሱ',
      successTitle: 'የይለፍ ቃሉ ተዘምኗል!',
      successMessage: 'የይለፍ ቃልዎ ዳግም ተጀምሯል። አሁን ባዲሱ የይለፍ ቃልዎ ሊግቡ ይችላሉ።',
      mismatch: 'የይለፍ ቃሎቹ አይመሳሰሉም።',
      invalidToken: 'ይህ የዳግም ማስጀመሪያ አገናኝ ልክ ያልሆነ ወይም ጊዜው ያለፈ ነው።',
    },
  },
  Hero: {
